...
// ===================
// hideshow.js modified for barebones-fold by Jacob Boxerman Dec 2022 <jakebox0@protonmail.com>
// URL: https://github.com/jakebox/org-html-barebones-fold
// 2022-12-06
// ===================
...
function hsCollapseChildren(header) {
	$(header).children('.hsExpanded').each(function () {
...
function hsToggleCollapsing(header) {
    if (header.parent().hasClass('hsCollapsed'))
        ...
        hsCollapse(header);
		hsCollapseChildren(header); // TODO
	}
}
...
function hsCollapseChildren(header) {
	// console.log(header);
	// $('hsExpanded', $(header)).each(function () {
	// 	console.log($(this)); //log every element found to console output
	// });

    header.children().children().each(function() {
		// console.log("got in here");
		console.log($(this).children('#content .hsExpanded'));
		hsCollapse($(this));
        // hsCollapse($(this).children(':header'));
    });
}

// TODO JAKE MY ADDITION
// function hsCollapseAllChildren() {
//     $('#content .hsExpanded').each (function() { // TODO NOT QUITE RIGHT
//         hsCollapse($(this).children(':header'));
//     });
// }
...
function hsInit() {
    for (var i = 0; i <= 7; i++) { // TODO JAKE MODIFIED THIS
